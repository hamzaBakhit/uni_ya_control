...
import 'package:uni_ya_control/constants/routes.dart';
...
class DetailsScreen extends StatefulWidget {
  DetailsScreen(this.meal, {Key? key}) : super(key: key);
  Meal meal;
  ...
  void initState() {
    ...
    additions.forEach((element) {
      if (context
        ...
        element.count = context
            .read<MakeOrderBloc>()
            .state
            .additionCount[widget.meal.id + "==" + element.id]!;
      } else {
        element.count = 0;
      }
    });
  ...
  Widget build(BuildContext context) {
    return ListTile(
      leading: CircleAvatar(
          backgroundColor: Colors.transparent,
          child: CachedImage(widget.addition.img)),
      ...
      trailing: Container(
        ...
        child: Wrap(crossAxisAlignment: WrapCrossAlignment.center, children: [
          ...
          GestureDetector(
            onTap: () => setState(() {
              print(context.read<MakeOrderBloc>().state.additions);
